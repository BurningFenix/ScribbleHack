...
# login is handled by the django.contrib.auth.views.login
# change the 'next' value in the template to change the redirect link
# next defaults to accounts/profile
